...
export const AboutData = {
    name: 'Usama Haider',
    description: 'I have over 5 years of experience in web, mobile app, and custom software development using technologies such as Elixir, Phoenix, Python, Django, FastAPI, Flask, ReactJs, React Native, NodeJs, and various DBMS. I have worked across industries including gaming, real estate, e-commerce, and more.',
    profile: profile,
};
...
export const projectsData = [
    {
        id: 1,
        name: 'Picaster',
        description: `PicCaster is a new and easy way to show your pictures, messages, or even business cards to others through TV screens or tablets. Just use your phone and your picture goes on a screen almost instantly. It's also a a new and easy way to make extra income using your TV or tablet.`,
        liveUrl: `https://piccaster.com/`,
